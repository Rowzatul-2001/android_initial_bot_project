import 'package:pet_care/utill/bar%20graph/bar_graph.dart';
          ...
          SizedBox(
            ...
            child: MyBarGraph(
              maxY: calculateMax(value, sunday, monday, tuesday, wednesday, thursday, friday, saturday),
                ...
                thuAmount:value.calculateDailyExpenseSummary()[tuesday]?? 0,
                wedAmount:value.calculateDailyExpenseSummary()[wednesday]?? 0,
                tueAmount:value.calculateDailyExpenseSummary()[thursday]?? 0 ,
